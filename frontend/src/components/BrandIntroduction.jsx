...
const BrandIntroduction = () => {
  return (
    <div className="bg-[#FAF9F6] py-16 sm:py-24">
          ...
          <div className="px-6 py-12 sm:p-16">
            <div className="prose prose-lg mx-auto text-gray-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12 border-t border-gray-100 pt-12">
                <div>
                  <h3 className="text-2xl font-serif text-gray-900 mb-4 tracking-tight">Mission</h3>
                ...
                <div>
                  <h3 className="text-2xl font-serif text-gray-900 mb-4 tracking-tight">Vision</h3>
                  <p className="leading-relaxed">
